  ...
  return (
    <header className="py-6 px-20 bg-white border-b border-gray-300 flex justify-between">
      <div className="space-x-10">
        <Link to="/about" className="font-medium text-black">
          О компании
        </Link>
        <Link to="/delivery" className="font-medium text-black">
          Доставка и оплата
        </Link>
        <Link to="/pricelist" className="font-medium text-black">
          Прайс-лист
        </Link>
      </div>
  ...
  return (
    <header className="relative py-3 px-20 bg-white border-b border-gray-300 flex items-center justify-between">
      ...
      <div className="flex items-center flex-grow mr-20 ml-20">
        <div className="relative w-full">
          <input
            ...
            className="border border-gray-300 rounded-lg px-10 py-2 w-full focus:outline-none focus:ring-2 focus:ring-sky-500"
          />
          <img
      ...
      <div className="flex items-center space-x-10">
        <Link to="/auth">
          <img src="/header/user_icon.svg" alt="User" className="h-8 w-8" />
        </Link>
        <Link to="/wishlist">
          <img
            src="/header/heart_icon.svg"
            alt="Wishlist"
            className="h-8 w-8"
          />
        </Link>
        <Link to="/cart">
          <img src="/header/cart_icon.svg" alt="Cart" className="h-8 w-8" />
        </Link>
      </div>
    </header>
  );
